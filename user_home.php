...
?>
	...
	<?php
      ...
      ?>
			...
			<li><a class="active" href="user_home.php">Customer</a></li>
			</ul>
		
		
		<h2 style="font-style:italic; font-size:35px;padding-left:30px;">Customer Dashboard</h2>
		...
		<div class="grid-container">
            ...
            <div style="text-align:right;"><img src="image\medicine.png"></div>  
			<div ><button type="button" class="btn" onclick="location.href=''">Customer History</button></div>
